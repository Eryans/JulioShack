  ...
  return (
    <div>
      <h1 className="text-center">
        Bienvenue dans notre monde de la folie de l'hébergement
        d'images !
      </h1>
      <br />
      Félicitations pour avoir réussi à entrer dans notre royaume chaotique où
      nous accueillons l'art du shitposting à bras ouverts. Nous sommes là pour
      vous fournir la meilleure application d'images qui répond à vos besoins
      les plus fous et les plus absurdes.
      <br />
      Maintenant que vous êtes connecté, laissez-nous vous guider à travers
      cette folie avec une visite rapide des merveilles de navigation qui vous
      attendent :
      <br />
      <br />
      <ul>
      ...
      l'hébergement d'images. Embrassez l'absurdité, embrassez la folie et
      n'hésitez jamais à libérer le seigneur du meme qui sommeille en vous.
      Rappelez-vous, dans ce royaume, la normalité n'est qu'un lointain
      souvenir.
      <br />
      Bonne exploration, cher aventurier ! Et souvenez-vous toujours, plus c'est
      étrange, mieux c'est !
      <br />
      P.S. Restez à l'écoute pour notre prochaine fonctionnalité qui vous
      permettra de transformer vos images en GIFs qui feront douter le monde de
      son existence même. Ça va être époustouflant !
    </div>
  )
}
